...
function loadData() {
  firebase.database().ref('Entry/').on('value',function(snapshot) {
    ...
    for (var i in entries){
      ...
      $('body').append(
      '<br><div class="coloures"> <br> <div class="row"> <div class="col s1 chip" id="name'+ num +'"></div> <div class="col s1 offset-s2 bubble"> <h6 id="genre'+num+'"></h6> </div> </div> <div class="row" class="likebox"> <h6 id="gname'+num+'" class="col s1 gname"></h6> <div class="col s1 offset-s9"> <img src="8bitlove.png" style="width:50px;height:50px;" class="like" id="like'+num+'"> </div> <div class="col s1"> <h6 class="count" id="count'+num+'"></h6> </div> </div> <div class="row"> <div class="col s2.5" id="postimage'+num+'">0</div> <div class="col s8 textu" id="story'+num+'"> <h6></h6> </div> </div> <br>'
      );
      $('#name' + num).empty();
      $('#story' + num).empty();
      $('#gname' + num).empty();
